...
class ArtistsAdapter(
    ...
    private val itemClickListener: ArtistsAdapter.OnItemClickListener
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val descriptionTextView: TextView = itemView.findViewById(R.id.artist_biography)
        val imageView: ShapeableImageView = itemView.findViewById(R.id.artist_image)
        val artistNumberButton: RelativeLayout = itemView.findViewById(R.id.artist_button)
